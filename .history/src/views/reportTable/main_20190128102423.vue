<template>
  <div>
     <tips
      ...
      @close="closeTips"
    ></tips>
    <div style='float: right;z-index:9999;right: 10px;bottom: 42px;position: relative;'><img @click="getBeCode" style='width:36px;height:36px;' src="../../assets/images/ewm.png"/></div>
