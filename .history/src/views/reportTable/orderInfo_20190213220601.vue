      ...
      <van-row v-show="type==1" id="rows">
        ...
        >
          ...
          <div style="width:85%;height: 30px;text-align: left;margin-bottom: 15px;">
            ...
            <span style="color: rgb(51, 51, 51)">{{orderInfo.order.send_city}} {{orderInfo.order.send_addr}}</span>
          </div>
          <!-- <div style="width:85%;height: 30px;text-align: left;margin-bottom: 15px;">
          ...
          <div style="width:85%;height: 30px;text-align: left;margin-bottom: 15px;">
            ...
            <span style="color: rgb(51, 51, 51)">{{orderInfo.order.recipient_city}} {{orderInfo.order.recipient_addr}}</span>
          </div>
          <!-- <div style="width:85%;height: 30px;text-align: left;margin-bottom: 15px;">
